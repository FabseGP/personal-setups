...
# Parameters
  ...
  DOTFILES_ETC="tlp.conf intel-undervolt.conf dinit.d/user/scripts/dbus-session pacman.d/hooks/{dinit-userservd.hook,electron-flags.hook,wireplumber-update.hook} zsh"
